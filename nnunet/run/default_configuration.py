...
def get_default_configuration(network, task, result_name, network_trainer, plans_identifier=default_plans_identifier,
    ...
    if result_name is not None:
        output_folder_name = join(network_training_output_dir, network, task, result_name)
    else:    
