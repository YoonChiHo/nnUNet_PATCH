...
class ExperimentPlanner3D_v21(ExperimentPlanner):
    ...
    """
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder, target_patch_size=None, target_batch_size=None):
    ...
    def get_properties_for_stage(self, current_spacing, original_spacing, original_shape, num_cases,
        ...
        if self.target_patch_size != None:
            for axis in range(3):
                while new_shp[axis] > self.target_patch_size[axis]:
                    tmp = deepcopy(new_shp)
