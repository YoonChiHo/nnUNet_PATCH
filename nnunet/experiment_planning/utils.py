...
# def crop(raw_task, target_task override=False, num_threads=default_num_threads):
#     cropped_out_dir = join(nnUNet_cropped_data, target_task)
#     maybe_mkdir_p(cropped_out_dir)
...
#     splitted_4d_output_dir_task = join(nnUNet_raw_data, raw_task)
#     lists, _ = create_lists_from_splitted_dataset(splitted_4d_output_dir_task)

#     imgcrop = ImageCropper(num_threads, cropped_out_dir)
#     imgcrop.run_cropping(lists, overwrite_existing=override)
#     shutil.copy(join(nnUNet_raw_data, raw_task, "dataset.json"), cropped_out_dir)
